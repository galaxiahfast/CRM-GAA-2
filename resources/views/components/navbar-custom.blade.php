    ...
    <div class="flex-1 px-0 pt-0 pb-4 overflow-y-auto">
        ...
        <ul class="font-medium inline-block min-w-full m-0 p-0">
            ...
            <li class="pt-[15px] px-[15px] pb-0 m-0">
                <span class="block text-[15px] font-medium text-gray-600 h-[15px] leading-none flex items-center">General</span>
            </li>
            ...
            <!-- ===== SECCIÓN: INFORMACIÓN ===== -->
            <li class="pt-[15px] px-[15px] pb-0 m-0">
                <span class="block text-[15px] font-medium text-gray-600 h-[15px] leading-none flex items-center">Información</span>
            </li>
            ...
            <!-- ===== SECCIÓN: ACTIVIDADES ===== -->
            <li class="pt-[15px] px-[15px] pb-0 m-0">
                <span class="block text-[15px] font-medium text-gray-600 h-[15px] leading-none flex items-center">Actividades</span>
            </li>
