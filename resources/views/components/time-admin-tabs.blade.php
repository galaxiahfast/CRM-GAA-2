...
<div class="space-y-0 bg-[#f4f4f4]">
    ...
    <div class="overflow-hidden bg-transparent px-[40px]">
        <div class="flex flex-nowrap gap-0 p-0 m-0">
            ...
            <a href="{{ route('time.admin.online') }}" class="flex flex-1 items-center justify-center gap-2.5 whitespace-nowrap border-b-2 p-5 text-[15px] font-medium transition {{ $active === 'online' ? 'border-[#1A3A6B] text-[#1A3A6B]' : 'border-gray-300 text-gray-500 hover:text-[#1A3A6B]' }}">
