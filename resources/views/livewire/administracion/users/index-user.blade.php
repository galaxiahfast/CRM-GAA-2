<div>
    <div class="mb-4 mt-6 flex justify-between items-center">
        ...
        <div class="mt-4">
            <input type="text" wire:model.live.debounce.250ms="search" placeholder="Buscar usuario..."
                class="border rounded-md px-2 py-1">
            <x-a-button href="{{ route('administracion.create.users') }}" color="blue">Agregar usuario</x-a-button>
        </div>
    </div>
        ...
        <x-slot name="body">
            @foreach ($users as $user)
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">{{ $user['last_name'] }}</td>
