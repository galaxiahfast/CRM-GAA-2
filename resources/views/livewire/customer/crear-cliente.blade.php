<div>
    ...
    @enderror
    <x-form-custom submit="storeCustomer">
        <x-slot name="title">
        ...
        <x-slot name="form">
            <div class="col-span-6">
                ...
                <x-input id="name" oninput="nameUpperCase()" required
                    class="mt-1 block w-full uppercase" wire:model.defer="name" maxlength="255" />
            ...
            <div class="col-span-6">
                ...
                <x-input id="email" class="mt-1 block w-full" wire:model.defer="email"
                    placeholder="ejemplo@gmail.com" maxlength="255" />
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <x-input required id="rfc" class="mt-1 block w-full uppercase" maxlength="13"
            ...
            <div class="col-span-6 mb-4">
                ...
                <div x-data="{
                    ...
                    class="bg-white-300 flex w-full flex-col gap-4 rounded-lg border border-solid p-4 md:flex-row">
                    <!-- Dropdown menu -->
                            ...
                            <div id="dropdownSearch" class="z-10 rounded-lg border border-solid">
                                <div class="relative">
                                    ...
                                    <input type="text" id="input-group-search"
                                        wire:model.live.debounce.500ms="searchA"
                                ...
                                <ul class="h-48 overflow-y-auto px-3 pb-3 text-sm text-gray-700"
                                    ...
                                    @else
                                        <div class="mt-14 flex items-center justify-center">
                                            <span
                                                class="border border-red-600 p-2 text-sm text-red-600">Sin
                                                contadores disponibles</span>
                                        </div>
                                    @endif
                            ...
                            <div wire:sortable="updateAccountantOrder"
                                ...
                                @if (empty($selectedAccountants))
                                    <div class="flex h-64 items-center justify-center">
                                        <span
                                            class="border border-red-600 p-2 text-sm text-red-600">Ningún
                                            contador seleccionado</span>
                                    </div>
                                @endif
                            </div>
            ...
            @foreach ($services as $service)
                <x-contracted-services>
                    <x-slot name="title">
                        {{-- <input name="selectedServices[]" type="checkbox"
                            id="{{ $service['id'] }}" wire:model="selectedServices"
                            value="{{ $service['id'] }}"
                            class="mr-2 h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-blue-500" /> --}}
