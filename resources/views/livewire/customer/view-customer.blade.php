<div class="relative mt-[24px] p-8">
    ...
    <div
        ...
        <div class="flex items-center gap-6">
            ...
            @if ($customer->url_photo)
                <div class="relative flex h-28 w-28 items-center justify-center rounded-full shadow">
        ...
        <div class="flex flex-col items-center gap-3">
            ...
            @php
                $percentage = $countPDFs > 0 ? round(($countPDFs / $totalPdfAvailable) * 100) : 0;
            @endphp
            @if ($selectedServiceId)
                <p class="{{ $percentage == 100 ? 'text-green-500' : 'text-gray-500' }} text-xs">
    ...
    @if ($selectedServiceId)
        <div class="mt-8">
                ...
                @foreach ($states as $key => $state)
                    ...
                    <div class="mb-8">
                        <div class="mb-4 flex items-center justify-between">
                            <span class="font-semibold text-gray-700">{{ $state->name }}</span>
                            <x-button @class([
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <x-format-pdf model="pdfs.normal.comprobante" :pdf="$normalFiles['comprobante']"
                                fileType="Comprobante" declarationType="Normal" :state="$state"
                                :successMessage="$successMessage" :comprobante-normal-is-visible="$complementariaFiles['acuse']->isEmpty() &&
                ...
                @foreach ($statements as $statement)
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <x-format-pdf model="pdfs.normal.comprobante" :pdf="$normalFiles['comprobante']"
                                fileType="Comprobante" declarationType="Normal" :statement="$statement"
                                :successMessage="$successMessage" :comprobante-normal-is-visible="$complementariaFiles['acuse']->isEmpty() &&
                                    $complementariaFiles['comprobante']->isEmpty()" />
            ...
            @else
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <!-- Archivos Normales -->
                    <x-format-pdf model="pdfs.normal.acuse" :pdf="$normalFiles['acuse']" :successMessage="$successMessage"
                        fileType="Acuse" declarationType="Normal" />
    ...
    @else
        <div class="relative flex h-[200px] items-center justify-center border">
            <span class="border border-gray-300 p-2 text-gray-400">Sin servicios contratados
                seleccionados </span>
        </div>
    @endif
</div>
