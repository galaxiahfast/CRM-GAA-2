<section class="w-full min-w-0 bg-gray-100 px-[80px]">
    <header class="flex items-center justify-between gap-6 pb-[25px]" style="padding-top: 75px;">
        <div>
    ...
    <div class="w-full pt-[5px]" style="padding-bottom: 55px;">
            <div class="w-full divide-y divide-gray-300">
                <article class="grid w-full min-w-0 grid-cols-[0.8fr_1.15fr_1.15fr_1fr] items-stretch">
                    <div class="flex min-h-[122px] min-w-0 items-center justify-start gap-[12px] border-r border-gray-300 py-[15px] pl-[20px] pr-[20px]">
                    ...
                    <div class="flex min-h-[122px] min-w-0 items-center justify-start border-r border-gray-300 py-[15px]" style="padding-left: 25px; padding-right: 20px;">
                    ...
                    <div class="grid min-h-[122px] place-items-center px-[15px] py-[15px]">
